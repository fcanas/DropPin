...
// SafeCast
#define COCOAPODS_POD_AVAILABLE_SafeCast
#define COCOAPODS_VERSION_MAJOR_SafeCast 1
#define COCOAPODS_VERSION_MINOR_SafeCast 0
#define COCOAPODS_VERSION_PATCH_SafeCast 0
